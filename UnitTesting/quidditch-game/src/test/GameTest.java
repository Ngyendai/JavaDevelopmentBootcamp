...
public class GameTest {
  ...
  public void getPlaceholderTest() {
    assertEquals("chaser", game.getPlaceholder("<chaser> get the next pass"));
  }

  @Test
  public void replacePlaceholderTest() {
    assertEquals(
      "Katie gets the next pass",
      game.replacePlaceholder("<chaser> gets the next pass", "chaser", "Katie")
    );
  }

  @Test
  public void quaffleScoreTest() throws IllegalAccessException {
  ...
  @Test
  public void catchSnitchTest() throws IllegalAccessException {
