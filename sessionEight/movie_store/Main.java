...
import movie_store.models.Movie;
import movie_store.models.Store;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      loadMovies(
        "D:\\Dong\\tranning\\java\\JavaDevelopmentBootcamp\\sessionEight\\movie_store\\movies.txt"
      );
  ...
  public static void manageMovies() {
    ...
    while (true) {
      ...
      if (
        !(response.equals("a") || response.equals("b") || response.equals("c"))
      ) {
        scan.close();
        break;
      }
  ...
  public static void loadMovies(String fileName) throws FileNotFoundException {
    ...
    while (scanFile.hasNextLine()) {
      ...
      store.addMovie(
        new Movie(words[0], words[1], Double.parseDouble(words[2]))
      );
    }
    scanFile.close();
  }
