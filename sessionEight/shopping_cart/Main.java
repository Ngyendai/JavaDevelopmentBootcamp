...
import shopping_cart.models.Cart;
import shopping_cart.models.Item;
import shopping_cart.models.Store;
...
public class Main {
  ...
  public static void main(String[] args)
    ...
    try {
      loadItems(
        "D:\\Dong\\tranning\\java\\JavaDevelopmentBootcamp\\sessionEight\\shopping_cart\\products.txt"
      );
      manageItems();
  ...
  public static void loadItems(String fileName)
    throws FileNotFoundException, NumberFormatException, IllegalAccessException {
