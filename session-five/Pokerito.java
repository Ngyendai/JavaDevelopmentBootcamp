...
public class Pokerito {
  ...
  public static void handleCard() {
    ...
    printRandom(yourCard, computerCard);
    printScreen();
    PressNumber(yourMatches, computerMatches, yourCard, computerCard);
    checkWin(yourMatches, computerMatches);
    scan.close();
  }

  public static void printRandom(String yourCard, String computerCard) {
    Scanner scan = new Scanner(System.in);
  ...
  public static void PressNumber(
    int yourMatches,
    int computerMatches,
    String yourCard,
    String computerCard
  ...
  public static void checkWin(int yourMatches, int computerMatches) {
