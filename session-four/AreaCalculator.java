public class AreaCalculator {
  ...
  public static void main(String[] args) {
    ...
    double square = areaSquare(10);
    double rectangle = areaRectangle(20, 30);
    double triangle = areaSquare(10);
  ...
  public static double areaCircle(double radius) {
    ...
    double number = Math.PI * radius * radius;
    return number;
  }
